        ...
        <table id="table" class="table table-striped table-bordered" style="width:100%; z-index: 1;">
            <thead>
                <tr>
                    ...
                    <td><input type="text" id="display_name" name="display_name" class="form-control" placeholder="Nome de exibição"></td>
                    <td><input type="text" id="description" name="description" class="form-control" placeholder="Descrição"></td>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#status').on('change',function () {
                table.columns(4).search( $('#status').val()).draw();
            });
            $('#dateStart').on('change',function () {
                table.columns(5).search( $('#dateStart').val()).draw();
            });
        }); 
    </script>
@stop
